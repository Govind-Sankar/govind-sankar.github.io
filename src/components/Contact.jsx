...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch(
        "https://script.google.com/macros/s/AKfycbzfrL8ubt835GE67cIu0Bkup2WzKlVJ5Gdtsa4hkN2BOoYShDT5CEUF2Vxvn6MsSSFYRg/exec",
        {
          method: "POST",
  ...
  return (
    <section id="contact" className="pt-5 pb-4 section-area scroll-m-10">
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid w-full sm:w-[75vw] md:w-[50vw] lg:w-[45vw] lg:grid-cols-2 sm:grid-cols-1 gap-4 pt-4">
          <span>
        ...
        <ReCAPTCHA
          sitekey="6Lf3abErAAAAAC0K-SEK00l6UrLMnfd3lpSWPvCu"
          className="pt-3"
        ...
        <div className="grid grid-flow-col auto-cols-max pt-2">
          {status === "loading" ? (
            <button
              className="mt-3 mb-3 py-2.5 px-2 w-20 rounded-md text-white bg-purple-600 hover:bg-purple-700 flex items-center justify-center"
              disabled
            >
              <svg
                width="32"
          ...
          {status === "error" && showAlert && (
            ...
            >
              ...
              <div className="ms-3 text-sm font-medium">
                Error in sending message! Recheck Captcha and your network
                connectivity.
              </div>
              <button
                type="button"
